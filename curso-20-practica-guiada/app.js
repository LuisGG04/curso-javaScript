...
class Book{
    ...
    bookInfo(){
        return `El libro se llama ${this.title} del autor ${this.author}. Es del año ${this.year} y del género ${this.gender}`
    }
}
...
while (books.length < 3){
    ...
    let gender = prompt("Introduzca el genero del libro (Aventura, terror o fantasía)").toLowerCase();
...
const showGender = () => {
    ...
    const gender = prompt("Introduce el género del libro que buscas")
